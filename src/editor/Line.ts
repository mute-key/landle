...
export class Line {
    ...
    #editedLineInfo = (currntRange: vscode.Range, fn: LineEditDefintion, _lineEdit_: IterateLineType[]): void => {
    ...
    #lineRecursion = (range: vscode.Range, callback: LineEditDefintion[], currentLineNumber: number, _lineEdit_: IterateLineType[]): IterateLineType[] => {
